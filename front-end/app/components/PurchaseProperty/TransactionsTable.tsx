...
function TransactionsTable() {
  ...
  return (
    <div className="flex flex-col items-center font-serif justify-center w-full mt-8 mb-8 sm-h-screen">
      <div className="flex flex-col w-full max-w-7xl bg-white dark:bg-gray-800 shadow-lg border border-gray-200 first:rounded-lg mt-8 p-6 z-0">
        <div className="flex flex-row justify-between items-center">
          ...
          <button
            type="button"
            className="py-3 px-8 rounded text-white bg-blue-500 dark:bg-blue-600 hover:bg-blue-600 dark:hover:bg-blue-700 disabled:bg-gray-500 disabled:cursor-not-allowed"
      ...
      <div className="flex flex-col w-full justify-center max-w-7xl bg-white dark:bg-gray-800 border border-gray-200 shadow-lg rounded-lg mt-6 mb-6 p-8 z-0">
        {loading ? (
                  ...
                  currentSchemas.map((txn) => (
                    <tr key={txn.txnHash}>
                      <td className="border-b p-4 text-gray-800 dark:text-gray-200 flex items-center">
                        ...
                        <FiCopy
                          className="ml-2 cursor-pointer text-blue-500 hover:text-blue-800"
